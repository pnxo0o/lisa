...
public class Fragment1 extends SherlockFragment {
	...
	public void crearDatos() {
		...
		ListViewExpanableItems grupo0 = new ListViewExpanableItems("Lechon");
		grupo0.children.add("Al horno");
		grupo0.children.add("A la parrilla");
		grupos.append(0, grupo0);

		ListViewExpanableItems grupo1 = new ListViewExpanableItems("Pescado");
		grupo1.children.add("Paella");
		grupo1.children.add("A la parrilla");
		grupo1.children.add("Frito");
		grupos.append(1, grupo1);

		ListViewExpanableItems grupo2 = new ListViewExpanableItems("Sandwichs");
